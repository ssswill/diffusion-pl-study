...
def main(args):
    ...
    # torch.save(model.model.model_unet.state_dict(), args.save_dict)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default="E:\\data\\celeba_hq_256\\train", type=str)
    parser.add_argument('--data_val', default="E:\\data\\celeba_hq_256\\test2", type=str)
    ...
    parser.add_argument('--n_timestep', default=2000, type=int)
